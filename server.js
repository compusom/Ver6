...
BEGIN
  ALTER TABLE dbo.facts_meta ADD CONSTRAINT [FK_facts_meta_clients] FOREIGN KEY (client_id) REFERENCES dbo.clients(client_id);
...
SELECT step, detail, status, rows FROM @actions;`;
        let result = await sqlPool.request().query(tsql);
