...
const META_COLUMN_MAP: { [key: string]: keyof PerformanceRecord } = {
    ...
    'captura video': 'videoCaptureFinal',
    ...
    'video capture final': 'videoCaptureFinal',
        ...
        clientJsonData.forEach(row => {
            ...
            if (!existingKeys.has(uniqueId)) {
                const numericRecord: PerformanceRecord = {
                    ...
                    campaignBudget: parseNumber(r.campaignBudget),
                    bid: parseNumber(r.bid),
                    ...
                    videoCapture: parseNumber(r.videoCapture),
                    videoCaptureFinal: parseNumber(r.videoCaptureFinal),
